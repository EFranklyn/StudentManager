...
const SocialMediaForm: React.FC<SocialMediaFormProps> = ({
  ...
  useEffect(() => {
    if (value) setSocialMedias(value);
  }, [value]);
    ...
    <div className="row ">
      <div className="row">
        <div className="col-6 col-lg-3">
          <blockquote className="mb-2 display-7 lead tw-bold">
            Redes Sociais
          </blockquote>
          {errors && errors["socialMedias"] && (
            <small className="text-danger">{errors["socialMedias"]}</small>
          )}
        </div>
        <div className="col-6 col-lg-3">
          <button
